// ============================================================
// FILE: src/app/(admin)/public-chat.tsx
// DESCRIPTION: Public chat screen for admins with real-time updates
// ============================================================
...
export default function AdminPublicChatScreen() {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await fetch(`http://10.7.33.242:5000/api/public-chat/messages/${messageId}`, {
                method: 'DELETE',
                headers: {
                  Authorization: `Bearer ${token}`,
                },
  ...
  useEffect(() => {
    if (socket && isConnected) {
      console.log('✅ Setting up socket listener for public messages (Admin)');
      ...
      <View style={styles.header}>
        ...
        {(isSuperAdmin || isDistrictAdmin) && (
          <TouchableOpacity
            ...
            onPress={() => setShowAdminActions(!showAdminActions)}
          >
            <Ionicons name="shield-outline" size={20} color="#D32F2F" />
          </TouchableOpacity>
        )}
      </View>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={[
            ...
            item.user_role === 'super_admin' && styles.adminMessage,
          ]}>
            ...
            <View style={styles.messageActions}>
              ...
              {(isSuperAdmin || isDistrictAdmin) && showAdminActions && (
                <TouchableOpacity
