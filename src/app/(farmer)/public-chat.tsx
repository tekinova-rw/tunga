// ============================================================
// FILE: src/app/(farmer)/public-chat.tsx
// DESCRIPTION: Public chat screen for farmers with real-time updates
// ============================================================
...
export default function PublicChatScreen() {
  ...
  useEffect(() => {
    if (socket && isConnected) {
      console.log('✅ Setting up socket listener for public messages');
