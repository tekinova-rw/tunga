// ============================================================
// FILE: src/app/(farmer)/ai-chat.tsx
// DESCRIPTION: AI Chat assistant screen for farmers
// ============================================================
...
export default function FarmerAIChatScreen() {
  ...
  const quickQuestions = [
    ...
    'How to identify pregnancy in cows?',
      ...
      {messages.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptySubtitle}>
            I can help you with animal health, diseases, treatments, and more.
          </Text>
